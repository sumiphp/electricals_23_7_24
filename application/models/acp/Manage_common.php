...
class Manage_common extends Ifix_Model
{
	...
	public function getdata2(){
		...
		return $this->db->get('homepagedetails2')->row();
	...
	public function updatedata1($data){
		return $this->db->update('homepagedetails2',$data);

	}



	public function addad($data1){
	return $this->db->insert('ad',$data1);
...
public function get_listad($bid = null)
{
...
function get_countlistorderdetails($orderid){
 ...
 function getdataordersnet($orderid){
