                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="addcarousal" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                      ...
                                                      <!--div class="row mb-3">
                                                      <div class="col-md-6">
                                                      <label for="contact-person" class="form-label text-primary">Enter description:</label>
                                                              <input type="text" class="form-control" id="title2" name="title2" placeholder="Enter Title2" required maxlength="300"> </div>
</select> </div>
...
$('#addcarousal').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addcarousalprocess';?>", // point to server-side controller method
