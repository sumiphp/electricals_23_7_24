                                                    ...
                                                    <form id="edit" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <img src="<?php echo base_url().'uploads/packagesgallery/'.$result->picture;?>" width="50" height="50" />
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <div class="col-md-6">
                                                          <label for="package" class="form-label text-primary">Package:</label>   
                                                          <select class="form-control" placeholder="Select Package" name="package" id="package"  data-bs-original-title="" title="" required>
                                                          <?php 
                                                    
                                                    
                                                    
                                                    foreach($result1 as $res){?>
                                                     <option value="<?php echo $res['contentid'];?>" <?php if ($res['contentid']==$result->packageid){ ?> selected <?php }?>><?php echo $res['title'];?></option>
...
$('#edit').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editgalleryprocess';?>", // point to server-side controller method
        ...
        $(this).val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listgallery';?>";
