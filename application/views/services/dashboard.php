                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listtourservices';?>" target="_blank">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listdestinations';?>" target="_blank">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listfaq';?>" target="_blank">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listauthority';?>" target="_blank">
