                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="prbmsg"></span><br>
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['downloadid'];?>" >
                                                   
                                                      <td class="sorting_1"><?php echo $res['title'];?></td>
                                                      <!--<td><?php //echo $res['link'];?></td>-->
                                                     
                                                      <td><?php echo $res['description'];?></td>
                                                      <td><img src=<?php echo base_url().'uploads/downloads/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editdownloads/'.$res['downloadid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                           <!--<li class="delete"><a href="#" onclick="delstepsrow(<?php echo $res['downloadid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>--->
