                                                    ...
                                                    <form id="add" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="testtitle" name="testtitle" placeholder="Facebook Link" required maxlength="25" >
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="testtitlear" name="testtitlear" placeholder="Twitter Link" required maxlength="25" >
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="testtitle1" name="testtitle1" placeholder="Be Link" required maxlength="25" >
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="testtitlear1" name="testtitlear1" placeholder="You tube Link" required maxlength="25" >
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="place" name="place" placeholder="Enter Designation"  required>
                                                          </div>
                                                      ...
                                                      <div class="row mb-3">
                                                      <div class="col-md-6">
                                                              <label for="designation" class="form-label text-primary">Phone No:</label>
                                                              <input type="text" class="form-control" id="namear" name="namear"  required placeholder="Enter Name Arabic">
                                                          </div>
                                                          <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">Email:</label>
                                                              <input type="text" class="form-control" id="placear" name="placear" placeholder="Enter Designation Arabic"  required>
                                                          </div>
...
$('#add').on('submit', function (e) {
    ...
    //alert("enter");
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addtmprocess';?>", // point to server-side controller method
