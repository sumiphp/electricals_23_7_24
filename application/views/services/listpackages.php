                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Package Title</th-->
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['contentid'];?>" >
                                                      ...
                                                      <td><img src=<?php echo base_url().'uploads/packages/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editpackages/'.$res['contentid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletepack';?>",
            data:{id:id},
