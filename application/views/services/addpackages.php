                                                ...
                                                <div class="product-info">
                                                    <form id="add" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Title" required maxlength="25">
                                                      ...
                                                      <!--div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="noofpeople" name="noofpeople" placeholder="Enter No of People" required maxlength="25">
                                                          </div>
                                                          <div class="col-md-6">
                                                          <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">No of Reviews:</label>
                                                              <input type="text" class="form-control" id="noofreviews" name="noofreviews" placeholder="Enter No of Reviews" required maxlength="25">
                                                          </div>
                                                          </div>
                                                      </div>
                                                    ...
                                                    <?php //}?>
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter Advertisement Description" required maxlength="170"></textarea>
                                                      </div>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       ...
       var description=$('#description').val();
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addpackagesprocess';?>", // point to server-side controller method
