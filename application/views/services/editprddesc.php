                                                    ...
                                                    <form id="qlfrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/editqualityprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control " id="title" name="title" placeholder="Enter Quality Title" maxlength="30" required value="<?php //echo $result->label;?>" >
                                                         ...
                                                         <div class="col-md-6">
                                                              ...
                                                              <input type="hidden" class="form-control numericvalidate" id="qualityid" name="qualityid"  required value="<?php //echo $result->prdspecid;?>">
                                                          </div>
                                                      </div>
                                                      <div class="row mb-3">
                                                      <div class="col-md-6">
