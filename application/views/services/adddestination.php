                                                    ...
                                                    <form id="add" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Work" required maxlength="25">
                                                      ...
                                                      <label for="status" class="form-label text-primary">Status:</label>   
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="alttagimg1" name="alttagimg1" required placeholder="Enter Alt tag Work Picture" value="<?php //echo $result->alttagimg1;?>">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="row mb-3"> 
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" placeholder="Select Status" name="showinfront" id="showinfront"  data-bs-original-title="" title="" required>
                                                                  ...
                                                                  <option value="0">Show in Services </option>
  </select>
                                                        </div>  
                                                      ...
                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary">Works Description:</label>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       ...
       var description=$('#description').val();
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/adddestinationprocess';?>", // point to server-side controller method
