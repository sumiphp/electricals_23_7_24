                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">From Destination</th>
                                                      ...
                                                      <!--th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Lastname</th>-->
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width:132px;">To Destination</th>
                                                                              ...
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">Duration</th>
                                                                              ...
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">From Date</th>
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">To Date</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['enquiryid'];?>" >
                                                      <td class="sorting_1"><?php echo $res['fromdest'];?></td>
                                                      <!--<td>Indoor Lamps</td>-->
                                                      <!--<td><?php //echo $res['lastname'];?></td>-->
                                                   
                                                      <td><?php echo $res['todest'];?></td>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/flightenquiries';?>",
            data:{id:id},
