                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['imgid'];?>" >
...
echo $result->title;
                                                      ...
                                                      <td><img src=<?php echo base_url().'uploads/packagesgallery/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editgallery/'.$res['imgid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['imgid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletegallery';?>",
            data:{id:id},
