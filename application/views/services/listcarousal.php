                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Display</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['carouselid'];?>" >
                                                      ...
                                                      <td><?php $showinfront=$res['showinfront'];
                                                      if ($showinfront==0){
                                                        echo "Show in Front";
                                                      }else{
                                                        echo "Show in Services";
                                                      ...
                                                      ?></td>
                                                      <td><img src=<?php echo base_url().'uploads/carousel/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editcarousel/'.$res['carouselid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['carouselid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletecarousel';?>",
            data:{id:id},
