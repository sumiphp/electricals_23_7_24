                                                      ...
                                                      <div class="row mb-3"> 
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" placeholder="Select Status" name="showinfront" id="showinfront"  data-bs-original-title="" title="" required>
                                                                  ...
                                                                  <option value="o" <?php if ($result->showinfront=='0'){?> selected <?php }?>>Show in front </option>
                                                                  <option value="1" <?php if ($result->showinfront=='1'){?> selected <?php }?>>Show in Work </option>
  </select>
                                                        </div>  
