                ...
                <div class="dashboard-innerbox">
                            <div class="inner-page-sec">
                              <div class="description-sec">
                                <h2> View Product Specifications  </h2>
                                <div class="row">
                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"><?php echo $this->session->flashdata('flash_msg');?></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Product</th>
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Label</th>
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Value</th>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    foreach($prdspec as $res){?>
                                                  <tr role="row" class="odd" id="<?php echo $res['prdspecid'];?>" >
                                                  <td class="sorting_1"><?php // $res['imgid'];
                                                      
                                                      
                                                      $this->db->where('itemid',$res['productid']);
	$this->db->select('*');
    $this->db->from('item');
    $query = $this->db->get();
   $imgdetails=$query->row();
   echo $image11=$imgdetails->itemname;
                                                      
                                                      
                                                      ?></td>
                                                      <td class="sorting_1"><?php echo $res['label'];?></td>
                                                      <td class="sorting_1"><?php echo $res['value'];?></td>
                                                    ...
                                                    <td>
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editprdspec/'.$res['prdspecid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delprdspec(<?php echo $res['prdspecid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
function delprdspec(id){

    $.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/delprdspec';?>",
            data:{id:id},
