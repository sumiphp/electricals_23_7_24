                ...
                <div class="dashboard-innerbox">
                            ...
                            <span id="faqmsg" style="color:green"></span><br>
                              <div class="description-sec">
                                <h2>Edit Flight Destination</h2>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="faqfrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/editflightprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Place:</label>
                                                              <input type="text" class="form-control" id="place" maxlength="250" name="place" placeholder="Enter place" value="<?php echo $result->place;?>" required>
                                                              <input type="text" class="form-control" id="placeid" name="placeid" placeholder="Enter Faq Id" value="<?php echo $result->placeid;?>" required>
                                                      ...
                                                      <a class="btn btn-primary me-3" href="<?php echo base_url().'Welcome/listflightdestination';?>" data-bs-original-title="" title="">View/Edit  </a>
...
$('#faqfrm').on('submit', function (e) {
   ...
   //alert("enter");
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editflightprocess';?>", // point to server-side controller method
    ...
    $("#description").val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listflightdestination';?>";
            },
