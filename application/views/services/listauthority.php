                                              ...
                                              <span id="msg"></span><br>
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['imgid'];?>" >
                                                      ...
                                                      <!--td class="sorting_1"><?php //echo $res['imgid'];?></td-->
                                                      <!--td><?php //echo $res['title2'];?></td>
                                                     
                                                      <td><?php //echo $res['title3'];?></td>
                                                      <td><?php //echo $res['title4'];?></td-->
                                                      <td><img src=<?php echo base_url().'uploads/authority/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editauthority/'.$res['imgid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deleteauth';?>",
            data:{id:id},
