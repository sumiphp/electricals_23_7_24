                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="add" class="rounded-form" method="post" >
                                                      ...
                                                      <a class="btn btn-primary me-3" href="<?php echo base_url().'Welcome/listauthority';?>" data-bs-original-title="" title="">View/Edit  </a>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addauthorityprocess';?>", // point to server-side controller method
