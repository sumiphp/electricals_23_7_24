                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    ...
                                                    <option value="<?php echo $res['itemid'];?>" <?php if ($result->productid==$res['itemid']){?> selected <?php }?>><?php echo $res['itemname'];?></option>
...
$('#edit').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editprdimgprocess';?>", // point to server-side controller method
        ...
        $(this).val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listproductimages';?>";
