                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="editcarousal" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="col-md-6">
                                                          <label for="status" class="form-label text-primary">Display:</label>   
                                                          <select class="form-control" placeholder="Select Status" name="showinfront" id="showinfront"  data-bs-original-title="" title="" required>
                                                                <option value=''>Select Display</option>
                                                                <option value="0" <?php if ($result->showinfront=='0'){?> selected <?php }?>>Show in front </option>
                                                                <option value="1" <?php if ($result->showinfront=='1'){?> selected <?php }?>>Show in Services </option>
</select>
                                                      </div>  
                                                      ...
                                                      <!--div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title3" name="title3" placeholder="Enter Title3" required maxlength="300" value="<?php echo $result->title3;?>">
                                                          </div>
                                                      </div-->
                                                      ...
                                                      <!--div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title4" name="title4" placeholder="Enter Title4" required maxlength="300" value="<?php echo $result->title4;?>">
                                                          </div>
                                                          <div class="col-md-6">
                                                              <label for="alttagimg1" class="form-label text-primary">Alt tag Image1:</label>
                                                              <input type="text" class="form-control" id="alttagimg1" name="alttagimg1" required placeholder="Enter Alt attribute" value="<?php //echo $result->alttagimg1;?>">
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <textarea class="form-control" id="title2" name="title2" rows="3" placeholder="Enter Description" required maxlength="170"><?php echo $result->title2;?></textarea>
                                                      </div>
...
$('#editcarousal').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        var showinfront=$("#showinfront").val();
