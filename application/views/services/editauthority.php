                                                    ...
                                                    <form id="edit" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <img src="<?php echo base_url().'uploads/authority/'.$result->picture;?>" width="50" height="50" />
...
$('#edit').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editauthorityprocess';?>", // point to server-side controller method
        ...
        $(this).val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listauthority';?>";
