                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="edit" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Service:</label>
                                                      ...
                                                      <div class="row mb-3"> 
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" placeholder="Select Status" name="showinfront" id="showinfront"  data-bs-original-title="" title="" required>
                                                                  ...
                                                                  <option value="0" <?php if ($result->showinfront=='0'){?> selected <?php }?>>Not in front </option>
                                                                  <option value="1" <?php if ($result->showinfront=='1'){?> selected <?php }?>>Show in front </option>
  </select>
                                                        </div>   </div> 
                                                      ...
                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary"> Services Description:</label>
