...
Subscribers</span></a>
                    ...
                    <li class="<?=(($main_menu_active == 'Clients')? 'active' : '')?>" style="<?=((!hasUserAccess(3))? 'display:none1;' : '')?>">
                        <a href="#" aria-expanded="true"><i class="fa fa-users"></i><span>Ad</span></a>
                        <ul class="collapse <?=(($main_menu_active == 'Clients')? 'in' : '')?>">
                            <li><a href="<?=site_url()?>acp/Settings/listad">List Ad</a></li>
                            <li><a href="<?=site_url()?>acp/Settings/addad">Add  Ad</a></li>
                        </ul>
                    </li>
