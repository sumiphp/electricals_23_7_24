                              ...
                              //die;
                                if (isset($product) && !empty($product)) {
                                    ...
                                    if (isset($product['Product']) && !empty($product['Product'])) {
                                        ...
                                        $prodMain['bestmove'] = $product['Product']['bestmove'];
                                        ...
                                        $prodMain['dealoftheday'] = $product['Product']['dealoftheday'];
                                        $prodMain['requestremark'] = $product['Product']['requestremark'];
                                        $prodMain['oldprice'] = $product['Product']['oldprice'];
                                        $prodMain['oldpriceusd'] = $product['Product']['oldpriceusd'];
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row" style=''>
																<div class="col-md-12 mb-3"><?php //print_r($prodMain);?>
                                                                    ...
                                                                    <label for="prodname" class="col-form-label"> Old Price(AED)*</label>
																	<input class="form-control"  type="text" id="oldprice" name="oldprice" placeholder="Enter Old Price" value="<?=((isset($prodMain['oldprice']) && !empty($prodMain['oldprice']))? $prodMain['oldprice'] : '')?>" required="required">
                                                            ...
                                                            <div class="form-group row" style=''>
																<div class="col-md-12 mb-3"><?php //print_r($prodMain);?>
																	...
																	<input class="form-control"  type="text" id="prodprice3" name="prodprice3" placeholder="Enter Product Price1" value="<?=((isset($prodMain['prod_price3']) && !empty($prodMain['prod_price3']))? $prodMain['prod_price3'] : '')?>" required="required">
                                                            ...
                                                            <div class="form-group row" style=''>
																<div class="col-md-12 mb-3"><?php //print_r($prodMain);?>
                                                                    ...
                                                                    <label for="prodname" class="col-form-label"> Old Price(Usd)*</label>
																	<input class="form-control"  type="text" id="oldpriceusd" name="oldpriceusd" placeholder="Enter Old Price" value="<?=((isset($prodMain['oldpriceusd']) && !empty($prodMain['oldpriceusd']))? $prodMain['oldpriceusd'] : '')?>" required="required">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label for="bestmove" class="col-form-label"> Best Move</label>
                                                                    <select class="form-control" id="bestmove" name="bestmove" style="height:43px;" required>
																	<option value="">Select</option>

                                                                    <?php if (isset($prodMain['bestmove'])){?>
																		<option value="1" <?php if (($prodMain['bestmove'])==1){?> selected <?php }?>>Yes</option>
                                                                        <option value="0" <?php if (($prodMain['bestmove'])==0){?> selected <?php }?>>No</option>
                                                                        <?php } else {?>
                                                                            <option value="1">Yes </option>
                                                                <option value="0">No</option>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label for="dealoftheday" class="col-form-label">Deal of the day</label>
                                                                    <select class="form-control" id="dealoftheday" name="dealoftheday" style="height:43px;" required>
																	<option value="">Select</option>

                                                                    <?php if (isset($prodMain['dealoftheday'])){?>
																		<option value="1" <?php if (($prodMain['dealoftheday'])==1){?> selected <?php }?>>Yes</option>
                                                                        <option value="0" <?php if (($prodMain['dealoftheday'])==0){?> selected <?php }?>>No</option>
                                                                        <?php } else {?>
                                                                            <option value="1">Yes </option>
                                                                <option value="0">No</option>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <select class="form-control" id="color" name="color" style="height:43px;" required>
																	<option value="">Select</option>

                                                                    <?php if (isset($prodMain['color'])){?>
																		<option value="White" <?php if (($prodMain['color'])=='White'){?> selected <?php }?>>White</option>
                                                                        <option value="Gray" <?php if (($prodMain['color'])=="Gray"){?> selected <?php }?>>Gray</option>
                                                                        <option value="Red" <?php if (($prodMain['color'])=="Red"){?> selected <?php }?>>Red</option>
                                                                        <option value="Black" <?php if (($prodMain['color'])=="Black"){?> selected <?php }?>>Black</option>
                                                                        <option value="Blue" <?php if (($prodMain['color'])=="Blue"){?> selected <?php }?>>Blue</option>
                                                                        <option value="Green" <?php if (($prodMain['color'])=="Green"){?> selected <?php }?>>Green</option>
                                                                        <?php } else {?>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label for="color" class="col-form-label">Size</label>
                                                                    <select class="form-control" id="size" name="size" style="height:43px;" required>
																	<option value="">Select</option>

                                                                    <?php if (isset($prodMain['color'])){?>
																		<option value="Large" <?php if (($prodMain['size'])==1){?> selected <?php }?>>Large</option>
                                                                        <option value="Medium" <?php if (($prodMain['size'])==0){?> selected <?php }?>>Medium</option>
                                                                        <option value="Small" <?php if (($prodMain['size'])==1){?> selected <?php }?>>Small</option>
                                                                        <option value="Tiny" <?php if (($prodMain['size'])==0){?> selected <?php }?>>Tiny</option>
                                                                        <?php } else {?>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label for="" class="col-form-label">Request Comment</label>
                                                                            <textarea class="form-control" id="requestremark" name="requestremark" placeholder="Enter Request Remark "rows="10"><?=((isset($prodMain['requestremark']) && !empty($prodMain['requestremark']))? $prodMain['requestremark'] : '')?></textarea>
