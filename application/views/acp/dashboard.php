                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-medall"></i> Bulk Enquires</div>
                                            <h2><?=number_format($bulk)?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-palette"></i> View Quotes</div>
                                            <h2><?=number_format($quotes)?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
