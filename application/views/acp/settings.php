                            ...
                            <div class="formArea">
                                ...
                                if (isset($settings) && !empty($settings)) {
                                    $setgDtl = array(
                                        ...
                                        'shippingamountusd' => $settings['shippingamountusd'],
                                        'shipmsg' => $settings['shipmsg'],
                                        'checkoutmsg' => $settings['checkoutmsg'],
                                        'vat' => $settings['vat'],
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="accordion41" class="collapse show" data-parent="#accordion4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="shippingamount" class="col-form-label">Shipping Amount-AED</label>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="shippingamount" class="col-form-label">Shipping Amount-USD</label>
                                                                    <input class="form-control" type="text" id="shippingamountusd" name="shippingamountusd" placeholder="Enter Shipping Amount-USD" value="<?=((!empty($setgDtl) && isset($setgDtl['shippingamountusd']))? $setgDtl['shippingamountusd'] : '')?>">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="shippingamount" class="col-form-label">VAT %</label>
                                                                    <input class="form-control" type="text" id="vat" name="vat" placeholder="Enter VAT" value="<?=((!empty($setgDtl) && isset($setgDtl['vat']))? $setgDtl['vat'] : '')?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="shippingamount" class="col-form-label">Shipping Message</label>
                                                                    <input class="form-control" type="text" id="shipmsg" name="shipmsg" placeholder="Enter Shipping Message" value="<?=((!empty($setgDtl) && isset($setgDtl['shipmsg']))? $setgDtl['shipmsg'] : '')?>">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="shippingamount" class="col-form-label">Order Message</label>
                                                                    <input class="form-control" type="text" id="checkoutmsg" name="checkoutmsg" placeholder="Enter Order Message" value="<?=((!empty($setgDtl) && isset($setgDtl['checkoutmsg']))? $setgDtl['checkoutmsg'] : '')?>">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="accordion44" class="collapse" data-parent="#accordion4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="site_email2_type" class="col-form-label">Site Bulk Order/Quotes Email</label>
                                                                    <div class="form-group row">
                                                                        <div class="col-md-4">
                                                                            <input class="form-control" type="text" readonly id="site_email2_type" name="site_email2_type" placeholder="Enter email type" value="<?=((!empty($setgDtl) && isset($setgDtl['site_email2_type']))? $setgDtl['site_email2_type'] : '')?>">
                                                                        </div>
                                                                        <div class="col-md-8">
