        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-7">
                <div class="title-area text-center">
                    ...
                    <p class="sec-text"><?php echo $sitedetails['contactus_note']?></p>
                </div>
            </div>
        </div>
...
$('#frmcontact').submit(function(event) {
    ...
    $("#message").val('');
        ...
        $('#msg').html("<span style='font-size:16px'>Your enquiry send successfully</span>");
...
if ($uri=='contact-us'){ ?>
//alert("hhhh-----");
$("#row15").addClass("Sale-box");

<?php }else{ ?>
    $("#row15").removeClass("Sale-box");
