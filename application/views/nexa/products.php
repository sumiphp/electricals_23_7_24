                           ...
                           <li class="menu-item-has-children">
                                    ...
                                    foreach ($brands as $brand) { 
                                       ...
                                       if ($brand['brand_status']==1){
                                        ...
                                        ?>
                                        <li><a href="<?php echo base_url().'products/brand/'.$brand['brand_canonial_name'];?>?cur=<?php echo $cur;?>"><?=$brand['brand_name']?><?//=$brand['brand_orderno']?>   </a></li>
                                        <!--li><a href="#">Alfanar   </a></li>
                                        <li><a href="#">Alfanar   </a></li>
                                        <li><a href="#">Alfanar   </a></li-->
                                        <?php //}
            ...
            <div class="col-auto mt-n2 mt-lg-0">
                <div class="sec-btn">
                    <div class="nav tab-menu1" role="tablist">
                        ...
                        <button class="tab-btn" id="nav-one-tab" data-bs-toggle="tab" data-bs-target="#nav-one" role="tab" aria-controls="nav-one" aria-selected="false">New Products</button>
                        <a href="#goto" class="tab-btn" style='color:#000'>Most Viewed Products</a>     
                    </div>
                </div>
            </div>
        </div>
...
<section class="space-btm-50" id="goto">
    <div class="container">
...
$("#row12").addClass("Sale-box");

<?php }else{ ?>
    
    $("#row12").removeClass("Sale-box");
