...
function curchange_old(val){
   <?php $url=base_url().'/viewquote.php?cur='.$cur;
                ...
                <form id="frmcontact" novalidate="true" class="contactForm" method="post" action="<?php echo base_url().'Home/contactquoteprocess';?>">
                            <div class="row">
                               ...
                               <?php } else {
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="producttype" id="producttype" required="" data-error="Please enter Product " class="form-control" placeholder="Product " value="<?php echo $_GET['prd'];?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
