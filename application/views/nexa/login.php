            ...
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="assets/img/e-shop/small-product1.png" alt="Product Image"></div>
                    </div>
                </div>
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            ...
                            <a href="#"><img src="assets/img/e-shop/small-product2.png" alt="Cart Image">MPCB</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="assets/img/e-shop/small-product3.png" alt="Cart Image">VALVE & ACTUATORS</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="assets/img/e-shop/small-product4.png" alt="Cart Image">LIMIT SWITCH & SENSORE</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="    #"><img src="assets/img/logo-eletrical.png" alt="Electrical Shop"></a>
            </div>
...
?>
    ...
    <div class="th-checkout-wrapper" style="background:url(<?php echo base_url().'/assets/img/e-shop/login.png';?>);background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 noPad">
                    <div class="our-login-form ">
                        <div class="woocommerce-info">Returning customer? <a href="<?php echo base_url().'/register';?>" >Click here to Register</a>
                        </div>
                       

                        <h6 style='color:red'><?php echo $this->session->flashdata('flash_msglogin');?></h6>
                        <form method="post" class="woocommerce-form-login mb-20" name="frm1" id="frm1" action="<?php echo base_url().'/home/loginprocess';?>">
                            <h1 class="log-title">Login</h1>
                            <div class="form-group">
                                <label>Username or email *</label>
                                <input type="email" class="form-control" placeholder="Username or email" name="username" maxlength="30" >
                            </div>
                            <div class="form-group">
                                <label>Password *</label>
                                <input type="password" class="form-control" placeholder="Password" name="password" required maxlength="20">
                            </div>
                            <div class="form-group">
