...
<section class="marquee-section">
    <div class="offer-text-wrap">
      ...
      <ul class="grid-wrap text2">
        ...
        <li class="grid-wrapper">
          <div class="richtext"><?php echo $homepagedetails->label23;?></div>
        </li>
      </ul>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <div class="img-content">
                            <img src="<?php echo base_url().'assets/uploads/homepage/'.$homepagedetails->image4;?>" alt="banner-img"/>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-xs-12">
                        <div class="content">
                            ...
                            <div class="add-cart-btn mt-4">
                                <a href="<?php echo $homepagedetails2->label26;?>" class="th-btn bg-white txt-black-color">Shop Now</a>
                            </div>
                        </div>
...
==============================-->
    <div class="space bg-blue">
        <div class="container th-container">
            ...
            <div class="col-lg-2">
                <div class="brand-card">
                <a href="<?=site_url()?><?='products/brand/'.$brand['brand_canonial_name']?>"><img src="<?=site_url()?>assets/uploads/brands/<?=$brand['brand_image']?>" alt="<?=$brand['brand_name']?>"></a>
                </div>
            </div>
            <?php } ?>
