        ...
        <div class="row justify-content-lg-between justify-content-center align-items-end">
            <div class="col-lg">
                <div class="title-area text-center text-lg-start">
                    <h2 class="sec-title">Best Selling Product</h2>
                </div>
            </div>
            <div class="col-auto mt-n2 mt-lg-0">
                <div class="sec-btn">
                    <div class="nav tab-menu1" role="tablist">
                        ...
                        <button class="tab-btn active" id="nav-one-tab" data-bs-toggle="tab" data-bs-target="#nav-one" role="tab" aria-controls="nav-one" aria-selected="false">Best Selling Products</button>
                        <a href="#goto" class="tab-btn active" style=''>Most View Product</a>      <!--a href="#goto"><button class="tab-btn" id="nav-one11" data-bs-toggle="tab" data-bs-target="#nav-one11" role="tab" aria-controls="nav-one11" aria-selected="false">Most View Product</button></a-->
                    </div>
                </div>
            </div>
        </div>
...
if ($uri=='home'){ ?>
//alert("hhhh-----");
$("#row11").addClass("Sale-box");

<?php }else{ ?>
    $("#row11").removeClass("Sale-box");
