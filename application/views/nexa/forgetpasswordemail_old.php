...
Checkout Arae
==============================-->
    <div class="th-checkout-wrapper " style="background:url(<?php echo base_url().'/assets/img/e-shop/forget.png';?>);background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 noPad">
                    <div class="our-login-form forget-form">
                        ...
                        <form method="post" name="frm1" id="frm1" action="<?php echo base_url().'home/forgetpasswordemailprocess';?>">
                            <h1 class="white-txt mb-15">Forget Password</h1>
                            <p class="white-txt">Lost your password? Please enter your email address. You will receive a link to create a new password via email.</p>
                            <div class="form-group">
                                <label> Email *</label>
                                

                                <input type="email" class="form-control" placeholder="Email" name="usernameemail" id="usernameemail" required>
                            </div>
