...
==============================-->
   <!--==============================
    Breadcumb
============================== -->
<?php //echo base_url().'assets/uploads/homepage/'.$homepagedetails2->clearenceimg1;?>

<a href="<?php echo base_url().$homepagedetails2->label27.'?cur='.$cur;?>">
    ...
    <div class="container">
     <div class="row justify-content-lg-between justify-content-center align-items-center">
       <div class="col-lg-6 col-md-6">
        ...
        <a href="<?php echo base_url().$homepagedetails2->label28;?>?cur=<?php echo $cur;?>">
           <img src="<?php echo base_url().'assets/uploads/homepage/'.$homepagedetails2->clearenceimg2;?>" alt="img-product"></a>
        </div>
       </div>
       <div class="col-lg-6 col-md-6">
        <div class="blog-img mb-30">
        <a href="<?php echo base_url().$homepagedetails2->label29;?>?cur=<?php echo $cur;?>">
...
echo round($product['discountper']).'% <br>OFF'; 
                            ...
                            <div class="actions">
                                ...
                                <a href="<?=site_url().'product/'.$product['prod_canonial_name']?>?cur=<?php echo $cur;?>" class="icon-btn popup-content1"><i class="far fa-eye"></i></a>
                                <!--a href="#" class="icon-btn"><i class="far fa-cart-plus"></i></a-->
...
echo  $currency.' '.$product['oldprice'];
                            ...
                            <!--div class="woocommerce-product-rating text-end" style='margin-left:220px;' role="img" aria-label="Rated 5.00 out of 5">
                                  fffff
                                </div-->
...
<?php } else { ?>
                                                ...
                                                <!--a href="#" class="icon-btn" onclick="addtocartaj(<?php //echo $product['prod_id'];?>)"><i class="far fa-cart-plus"></i></a-->
                                                <a href="#" class="th-btn" onclick="addtocartaj(<?php echo $product['prod_id'];?>)"><i class="far fa-cart-shopping mr-5"></i> Add to Cart</a>
...
<section class="space-btm-50">
    <div class="container">
        <div class="row ">
            <div class="col-xl-8 col-lg-8 col-md-6">
                <div class="row justify-content-lg-between justify-content-center align-items-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="blog-img mb-30">
                        <a href="<?php echo base_url().$homepagedetails2->label30;?>?cur=<?php echo $cur;?>">
            ...
            <?php //print_r($productsdealoftheday);?>
