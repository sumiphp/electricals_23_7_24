                        ...
                        <div class="sidebar__item">
                           ...
                           <li class="menu-item-has-children">
                                    ...
                                    foreach ($brands as $brand) { 
                                        ...
                                        ?>
                                        <li><a href="<?php echo base_url().'products/brand/'.$brand['brand_canonial_name'];?>"><?=$brand['brand_name']?>   </a></li>
                                        <!--li><a href="#">Alfanar   </a></li>
                                        <li><a href="#">Alfanar   </a></li>
                                        <li><a href="#">Alfanar   </a></li-->
                                        <?php }
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 mb-40 mb-lg-0">
                <aside class="sidebar-area best-box-area">
                    ...
                    <div class="widget  ">
                        ...
                        <?php foreach ($bestmove as $product) { ?>
                            <div class="recent-post">
                                <div class="media-img">
                                    <a href="<?php echo site_url().'product/'.$product['prod_canonial_name']?>"><img src="<?=site_url()?>assets/uploads/products/<?=$product['prod_primary_image']?>" alt="<?=$product['prod_name']?>" title="<?=$product['prod_name']?>"></a>
                                </div>
                                <div class="media-body">
                                    <h4 class="post-title"><a class="text-inherit" href="<?php echo site_url().'product/'.$product['prod_canonial_name']?>"><?=$product['prod_name']?></a></h4>
                ...
                <div class="row justify-content-lg-between justify-content-center align-items-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="blog-img mb-30">
                            3<img src="<?=site_url()?>assets/img/e-shop/product page offer image.png"/ alt="img-product">
                        </div>
                    </div>
    ...
    <?php }else{
        ...
        <div class="row justify-content-lg-between justify-content-center align-items-center space-50">
            <div class="col-lg-6 col-md-6">
                <div class="blog-img mb-30">
                    1<img src="<?=site_url()?>assets/img/e-shop/offer-img.png" alt="img-product">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="blog-img mb-30">
                    2<img src="<?=site_url()?>assets/img/e-shop/offer-img.png" alt="img-product">
                </div>
            </div>
        </div>
        <div class="tab-content best-selling-product">
