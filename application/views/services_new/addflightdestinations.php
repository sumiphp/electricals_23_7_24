                ...
                <div class="dashboard-innerbox">
                            ...
                            <span id="faqmsg" style="color:green"></span><br>
                              <div class="description-sec">
                                <h2>Add Flight destinations</h2>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="faqfrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/addflightdestprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Flight destinations Place:</label>
                                                              <input type="text" class="form-control" id="place" name="place" placeholder="Enter Flight destination Place" required maxlength="250" >
...
$('#faqfrm').on('submit', function (e) {
   ...
   //alert("enter");
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addflightdestprocess';?>", // point to server-side controller method
