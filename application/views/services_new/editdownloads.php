                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="editdownloads1" class="rounded-form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'Welcome/editdownloadsprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="hidden" class="form-control" id="downloadid" name="downloadid"  value="<?php echo $result->downloadid;?>"  required>
                                                          </div>
                                                          <div class="col-md-6">
                                                              <label for="company-logo" class="form-label text-primary">Image1:</label>
                                                              <input type="file" class="form-control" id="image1" name="image1" >
                                                              <img src="<?php echo base_url().'uploads/downloads/'.$result->picture;?>" width="50" height="50" />
                                                          </div>
                                                      </div>
                                                      <div class="row mb-3">
                                                      ...
                                                      <div class="mb-3">
                                                          ...
                                                          <textarea class="form-control" id="description" name="description" rows="8" maxlength="700" placeholder="Enter Description"><?php echo $result->description;?></textarea>
                                                      </div>
