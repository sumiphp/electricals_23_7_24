                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Work</th>
                                                      <!--th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">Country</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['contentid'];?>" >
                                                      ...
                                                      <td class="sorting_1"><?php echo $res['city'];?></td>
                                                      <!--sstd><?php //echo $res['country'];?></td>
                                                     
                                                      <td><?php //echo $noofstars=$res['noofstars'];
                                                      ...
                                                      <td><img src=<?php echo base_url().'uploads/dest/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editdestination/'.$res['contentid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['contentid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletedest';?>",
            data:{id:id},
