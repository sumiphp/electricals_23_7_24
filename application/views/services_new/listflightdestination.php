                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Place</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['placeid'];?>" >
                                                      <td class="sorting_1"><?php echo $res['place'];?></td>
                                                      <!--<td>Indoor Lamps</td>-->
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editflightdest/'.$res['placeid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="deldest(<?php echo $res['placeid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
function deldest(id){
    ...
    $.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deldest';?>",
            data:{id:id},
