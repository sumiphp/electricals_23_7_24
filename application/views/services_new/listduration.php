                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['durationid'];?>" >
                                                      <td class="sorting_1"><?php echo $res['durationperiod'];?></td>
                                                      <!--<td>Indoor Lamps</td>-->
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <!--li class="edit"> <a href="<?php //echo base_url().'Welcome/editflightdest/'.$res['durationid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li-->
                                                          <li class="delete"><a href="#" onclick="del(<?php echo $res['durationid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
function del(id){
    ...
    $.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/delduration';?>",
            data:{id:id},
