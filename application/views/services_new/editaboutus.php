                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="editaboutus" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">About Lalgy:</label>
                                                          <textarea class="form-control" id="aboutcompany" name="aboutcompany" rows="6" placeholder="About Company" required maxlength="600"><?php echo $result->aboutcompany;?></textarea>
                                                      </div>
                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Enter Mission:</label>
                                                          <textarea class="form-control" id="mission" name="mission" rows="6" placeholder="About Mission" required maxlength="600"><?php echo $result->mission;?></textarea>
                                                      </div>
                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Enter Vision:</label>
                                                          <textarea class="form-control" id="vision" name="vision" rows="6" placeholder="About Vision" required maxlength="600"><?php echo $result->vision;?></textarea>
                                                      </div>

                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">About Lalgy Short Description:</label>
                                                          <textarea class="form-control" id="shortdesc" name="shortdesc" rows="6" placeholder="About Company Short Description" maxlength="700" required><?php echo $result->aboutusshortdesc;?></textarea>
                                                      </div>
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                          <label for="company-logo" class="form-label text-primary">Years of Experience :</label>
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                          <label for="company-logo" class="form-label text-primary"> 	Our Projects :</label>
...
$('#editaboutus').on('submit', function (e) {
   ...
   //alert("enter");
      ...
      form_data.append('image1', file_data1);
        ...
        form_data.append('nowinning',nowinning);
