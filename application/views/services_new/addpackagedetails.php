                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    ...
                                                    foreach($result as $res){?>
                                                     <option value="<?php echo $res['contentid'];?>" multiple><?php echo $res['title'];?></option>
                                                    ...
                                                    <?php }?>
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <textarea class="form-control" id="desc5" name="desc5" rows="3" placeholder="Enter Package Details Description" required maxlength="170"></textarea>
                                                      </div>
                                                     
                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary">Enter Famous Places Description:</label>
                                                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter Description1" required maxlength="170"></textarea>
                                                      </div>
                                                    

                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary">Enter cityvisit Description:</label>
                                                          <textarea class="form-control" id="description2" name="description2" rows="3" placeholder="Enter Description2" required maxlength="170"></textarea>
                                                      </div>


                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary">Enter rooms Description:</label>
                                                          <textarea class="form-control" id="description3" name="description3" rows="3" placeholder="Enter Description3" required maxlength="170"></textarea>
                                                      </div>


                                                      <div class="row mb-3">
                                                          <label for="address" class="form-label text-primary">Enter food Description:</label>
                                                          <textarea class="form-control" id="description4" name="description4" rows="3" placeholder="Enter Description4" required maxlength="170"></textarea>
                                                      </div>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       ...
       var description4=$('#description4').val();
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addpackagesdetailsprocess';?>", // point to server-side controller method
