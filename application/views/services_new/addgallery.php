                                                ...
                                                <div class="product-info">
                                                    <form id="add" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <div class="col-md-6"> <label for="package" class="form-label text-primary">Package:</label>   
                                                    ...
                                                    <?php }?>
                                                      ...
                                                      <a class="btn btn-primary me-3" href="<?php echo base_url().'Welcome/listgallery';?>" data-bs-original-title="" title="">View/Edit  </a>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addgalleryprocess';?>", // point to server-side controller method
