...
<label for="contact-person" class="form-label text-primary">Alt Tag Image3:</label>
    <input type="text" class="form-control" id="alttagimg3" name="alttagimg3" required placeholder="Enter Alt attribute3" value="<?php //echo $result->alttagimg2;?>">
...
<div class="row mb-3">
    ...
    <input type="text" class="form-control" id="alttagimg4" name="alttagimg4" required placeholder="Enter Alt attribute4" value="<?php //echo $result->alttagimg2;?>">
