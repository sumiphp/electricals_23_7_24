                                                ...
                                                <div class="product-info">
                                                    <form id="addservices" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="mb-3">
                                                          ...
                                                          <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter Description" required maxlength=1030><?php echo $result->description;?></textarea>
                                                      </div>

                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Description2:</label>
                                                          <textarea class="form-control" id="description2" name="description2" rows="4" placeholder="Enter Description2" required maxlength=1030><?php echo $result->description2;?></textarea>
                                                      </div>

                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Footer Description:</label>
                                                          <textarea class="form-control" id="description3" name="description3" rows="4" placeholder="Front Page Description" required maxlength=1030><?php echo $result->description3;?></textarea>
                                                      </div>
                                                      <div class="mb-3">
