                                                    ...
                                                    <form id="edit" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title" name="title" value="<?php echo $result->city;?>" placeholder="Place" required maxlength="25">
...
$('#edit').on('submit', function (e) {
    ...
    //alert("add");
       ...
       var description=$('#description').val();
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/edittraveldetailsprocess';?>", // point to server-side controller method
    ...
    window.location.href ="<?php echo base_url().'Welcome/listtraveldetails';?>";
