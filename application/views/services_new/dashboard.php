                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listbookenquiries';?>" target="_blank">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listpackages';?>" target="_blank">
                                                    <div class="card-body rounded gradient-2">
                                                        <div class="media  align-items-center">
                                                            <img class="mr-3 mt-2" src="<?php echo base_url().'/assets/img/dashborad-icon/2.png';?>" alt="">
                                                            <div class="media-body pl-3">
                                                                <h2><?php echo $rowcountpackages;?></h2>
                                                                <h6 class="text-uppercase text-white">Our works</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </a>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6" >
                                                <div class="card">
                                                    <a href="<?php echo base_url().'Welcome/listpckenquiries';?>" target="_blank">
                                                    <div class="card-body rounded gradient-5">
                                                        <div class="media  align-items-center">
                                                            <img class="mr-3 mt-2" src="<?php echo base_url().'/assets/img/dashborad-icon/3.png';?>" alt="">
                                                            <div class="media-body pl-3">
                                                                <h2><?php echo $rowcountpckenquiries;?></h2>
                                                                <h6 class="text-uppercase text-white">Clients</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
