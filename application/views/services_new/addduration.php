                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="faqfrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/adddurationprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Duration:</label>
                                                              <input type="text" class="form-control" id="duration" name="duration" placeholder="Enter Duration" required maxlength="250" >
                                                      ...
                                                      <a class="btn btn-primary me-3" href="<?php echo base_url().'Welcome/listduration';?>" data-bs-original-title="" title="">View/Edit  </a>
...
$('#faqfrm').on('submit', function (e) {
   ...
   //alert("enter");
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/adddurationprocess';?>", // point to server-side controller method
