                                              ...
                                              <span id="msg"></span> <?php echo $this->session->flashdata('flash_msg')?>;<br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <!--<th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Subtitle</th>-->
                                                                              ...
                                                                              <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">Site Title</th>
                                                  ...
                                                  <td><?php echo $siteinf->sitename;?></td>
                                                     ...
                                                     <td><?php echo $siteinf->sitetitle;?></td>
