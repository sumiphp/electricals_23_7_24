                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="editproduct" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Product Name" required maxlength="25" value="<?php echo $result->itemname;?>" >
                                                              <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $result->itemid;?>"    />
                                                          </div>
                                                          <div class="col-md-6">
                                                              <label for="company-logo" class="form-label text-primary">Product Picture:</label>
                                                              <input type="file" class="form-control" id="image1" name="image1" required>
                                                              <img src="<?php echo base_url().'uploads/item/'.$result->picture;?>" width="50" height="50" />
                                                          </div>
                                                      </div>
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">Product Model:</label>
                                                              <input type="text" class="form-control" id="title2" name="title2" placeholder="Enter Product Model" required maxlength="25" value="<?php echo $result->model;?>">
                                                          </div>
                                                          <div class="col-md-6">
                                                    ...
                                                    <option value="<?php echo $res['producttypeid'];?>" <?php  if ($res['producttypeid']==$result->type){?> selected <?php } ?>><?php echo $res['producttypetitle'];?></option>
                                                    ...
                                                    <?php } ?>
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter Description" required maxlength="170"><?php echo $result->itemdesc;?></textarea>
                                                      </div>
...
$('#editproduct').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editproductprocess';?>", // point to server-side controller method
        ...
        $(this).val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listitems';?>";
            },
