                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><?php echo $this->session->flashdata('flash_msg');?><br><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 350px;">About Us</th>
