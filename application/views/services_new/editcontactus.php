                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="editcontactus" class="rounded-form" method="post" enctype="multipart/form-data" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Phoneno1:</label>
                                                      ...
                                                      <div class="row mb-3">
 <div class="col-md-6">
                                                      <label for="company-name" class="form-label text-primary">Phone no2:</label>
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <label for="company-name" class="form-label text-primary">Street Address:</label>
                                                              <!--input type="text" class="form-control" id="street" name="street" placeholder="Street Address" required value="<?php //echo $result->street;?>" -->
                                                      ...
                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Contact Us description1:</label>
                                                          <textarea class="form-control" id="description" name="description" rows="3" maxlength="610"  placeholder="Contact Us description1" required><?php echo $result->contactusdescription;?></textarea>
                                                      </div>

                                                      <div class="mb-3">
                                                          <label for="address" class="form-label text-primary">Contact Us description2:</label>
                                                          <textarea class="form-control" id="description2" name="description2" rows="3" maxlength="610"  placeholder="Contact Us description2" required><?php echo $result->description2;?></textarea>
                                                      </div>
