                ...
                <span id="msg"></span><br>
                            <div class="inner-page-sec">
                              ...
                              <?php echo $this->session->flashdata('flash_msg');?>  
                                <h2>Edit Package Page</h2>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="edit" class="rounded-form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'Welcome/editpckprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="hidden" class="form-control" id="id" name="id"  value="<?php echo $result->pckid;?>"  required>
                                                          </div>
                                                          <div class="col-md-6">
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <img src="<?php echo base_url().'uploads/packages/'.$result->picture2;?>" width="50" height="50" />
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Title3:</label>
                                                              <input type="text" class="form-control" id="title3" name="title3" placeholder="Enter Title3" maxlength="300" value="<?php echo $result->title3;?>"  required>
