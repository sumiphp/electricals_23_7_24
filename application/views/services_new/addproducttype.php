                                        ...
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="producttypefrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/addproducttypeprocess';?>" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Product Type :</label>
                                                              <input type="text" class="form-control" id="producttypetitle" name="producttypetitle" placeholder="Enter Product Type " required maxlength="50" >
...
$('#producttypefrm').on('submit', function (e) {
  ...
  //alert("enter");
        ...
        var producttypetitle=$('#producttypetitle').val();
        ...
        form_data.append('producttypetitle',producttypetitle);
        form_data.append('status',status);
        form_data.append('description',description);
       
        $.ajax({
            url: "<?php echo base_url().'Welcome/addproducttypeprocess';?>", // point to server-side controller method
